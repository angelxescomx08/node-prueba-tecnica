...
exports.userPATCH = exports.userDELETE = exports.userPUT = exports.userPOST = exports.userGETById = exports.userGET = void 0;
...
const userDELETE = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const user = yield user_1.User.findByIdAndUpdate(id, { state: false }, { new: true });
